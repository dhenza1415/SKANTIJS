...
def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 =  "╔═[🇦🇱S⃟I⃟L⃟E⃟N⃟T⃟ T⃟E⃟A⃟M⃟B⃟O⃟T⃟🇦🇱]═╗\n│Using key「 " + key + " \n" + \                          
...
def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage2 =  "╔═[🇦🇱S⃟I⃟L⃟E⃟N⃟T⃟ T⃟E⃟A⃟M⃟B⃟O⃟T⃟🇦🇱]═╗\n│Using key「 " + key + " \n" + \             
                  "╠✪➣ " + key + "Notag「on/off」\n" + \
                  "╠✪➣ " + key + "Semuapro「on/off」\n" + \
...
def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage3 =  "╔═[🇦🇱S⃟I⃟L⃟E⃟N⃟T⃟ T⃟E⃟A⃟M⃟B⃟O⃟T⃟🇦🇱]═╗\n│Using key「 " + key + " \n" + \   
                  "╠✪➣ " + key + "Sticker「on/off」\n" + \
                  "╠✪➣ " + key + "Respon「on/off」\n" + \
                  "╠✪➣ " + key + "Contact「on/off」\n" + \
                  "╠✪➣ " + key + "Autojoin「on/off」\n" + \
...
def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 =  def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage4 = "╔═[🇦🇱S⃟I⃟L⃟E⃟N⃟T⃟ T⃟E⃟A⃟M⃟B⃟O⃟T⃟🇦🇱]═╗\n│Using key「 " + key + " \n" + \    
                  "╠✪➣ " + key + "Admin:on\n" + \
                  "╠✪➣ " + key + "Admin:repeat\n" + \
                  "╠✪➣ " + key + "Staff:on\n" + \
                  "╠✪➣ " + key + "Staff:repeat\n" + \
...
def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage4 = "🇦🇱🇦🇱S⃟I⃟L⃟E⃟N⃟ T⃟E⃟A⃟M⃟B⃟O⃟T⃟🇦🇱🇦🇱\n│Not Using key「 " + key + " 」\n" + \
                   "╠✪➣ "  + key + "Blc\n" + \
                   "╠✪➣ "  + key + "Ban:on\n" + \
                   "╠✪➣ "  + key + "Unban:on\n" + \
                   "╠✪➣ "  + key + "Ban「@」\n" + \
